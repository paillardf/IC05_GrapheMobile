...
public abstract class AbstractAttributeModel implements AttributeModel {
    ...
    //Classes
    private HashMap<String, AttributeTableImpl> tableMap;
    ...
    public AbstractAttributeModel() {
        tableMap = new HashMap<String, AttributeTableImpl>();
        nodeTable = new AttributeTableImpl(this, null);//NbBundle.getMessage(AttributeTableImpl.class, "NodeAttributeTable.name"));
        edgeTable = new AttributeTableImpl(this, null);//NbBundle.getMessage(AttributeTableImpl.class, "EdgeAttributeTable.name"));
